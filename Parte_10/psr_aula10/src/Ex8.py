...
# rosbag play lidar_example
# rviz
# rosrun psr_aula10 Ex8_9.py laser_scan:=/left_laser/lasersca
...
def callbackMsgReceived(msg):
    rospy.loginfo("Receiving Message")
    thresh = 0.8
...
def main():
    ...
    rospy.Subscriber('laser_scan', LaserScan, callbackMsgReceived)
